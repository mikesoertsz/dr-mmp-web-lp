      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center text-white max-w-4xl mx-auto">
          ...
          <p className="text-xl text-blue-200 mb-8 max-w-2xl mx-auto">
            Showcase your property from breathtaking aerial perspectives that capture attention and drive more inquiries.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button size="lg" className="bg-white text-blue-600 hover:bg-blue-50">
              <Calendar className="mr-2 h-5 w-5" />
              Book Drone Photography
            </Button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
              <div className="text-2xl font-bold mb-2">4K Video</div>
              <div className="text-blue-200">Ultra High Quality</div>
            </div>
            <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6">
