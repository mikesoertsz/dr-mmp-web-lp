  ...
  const galleryImages = [
    {
      ...
      alt: "Modern villa 3D render"
    },
    {
      id: 2,
      category: "interior",
      src: "https://images.pexels.com/photos/1571460/pexels-photo-1571460.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=2",
      alt: "Luxury living room 3D render"
    },
    {
      id: 3,
      category: "aerial",
      src: "https://images.pexels.com/photos/2119713/pexels-photo-2119713.jpeg?auto=compress&cs=tinysrgb&w=800&h=600&dpr=2",
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <p className="text-lg text-slate-600 dark:text-slate-400">
            Explore our collection of photorealistic 3D renders across various property types
          </p>
        </div>
        ...
        <div className="mt-12 text-center">
          <div className="bg-gradient-to-r from-blue-600 to-blue-700 rounded-lg p-8 text-white max-w-2xl mx-auto">
            <h3 className="text-2xl font-bold mb-4">Ready to Visualize Your Project?</h3>
