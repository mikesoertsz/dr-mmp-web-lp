  ...
  const companyStats = [
    {
      ...
      value: "1000+",
      label: t("about.propertiesMarketed"),
    },
    {
    ...
    },
    {
      ...
      value: "98%",
      label: t("about.satisfactionRate"),
    },
    {
      icon: <Globe className="h-8 w-8 text-blue-600 mx-auto mb-3" />,
      value: "15+",
      label: t("about.citiesServed"),
    },
  ];
    ...
    <Wrapper className="py-12 md:pt-12 md:pb-32">
      <InnerWrap className="flex flex-col gap-8 h-full min-h-[500px]">
        <div className="w-full h-full flex items-start justify-center">
          <TitleBlock
            preheading={t("about.ourCompany")}
            heading={t("about.ourCompany")}
            body={t("about.ourCompanyDescription")}
            theme="light"
            orientation="center"
          />
        </div>
