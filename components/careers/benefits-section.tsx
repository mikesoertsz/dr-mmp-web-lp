      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto">
            We believe in investing in our freelance partners&apos; success.
            Here&apos;s what you get when you join our network.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {careersContent.benefits.map(
            (
              category: { icon: string; category: string; benefits: string[] },
              index: number
            ) => {
              const IconComponent =
        ...
        <div className="mt-16 bg-slate-50 dark:bg-slate-900 rounded-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-slate-600 dark:text-slate-400">
              Our streamlined processes make collaboration efficient and
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <ol className="space-y-2">
                {careersContent.workingWithUs.projectFlow.map(
                  (step: string, index: number) => (
                    <li
                      key={index}
                      className="text-sm text-slate-600 dark:text-slate-400 flex items-start"
                    >
                      <span className="text-blue-600 dark:text-blue-400 font-medium mr-2 mt-0.5">
                        {index + 1}.
                      </span>
                      {step}
                    </li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                {careersContent.workingWithUs.paymentTerms.map(
            ...
            <div>
              ...
              <ul className="space-y-2">
                {careersContent.workingWithUs.communication.map(
