            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <ul className="space-y-3">
                  {careersContent.applicationProcess.requirements.map((req, index) => (
          ...
          <div className="mt-12 text-center">
            ...
            <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-8">
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">1-2 Days</div>
                <div className="text-sm text-slate-600 dark:text-slate-400">Application Review</div>
              </div>
              <div className="hidden md:block text-slate-400">→</div>
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">3-5 Days</div>
                <div className="text-sm text-slate-600 dark:text-slate-400">Skills Assessment</div>
              </div>
              <div className="hidden md:block text-slate-400">→</div>
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">1 Week</div>
                <div className="text-sm text-slate-600 dark:text-slate-400">Interview & Trial</div>
              </div>
              <div className="hidden md:block text-slate-400">→</div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600 dark:text-green-400">Onboarding</div>
                <div className="text-sm text-slate-600 dark:text-slate-400">Welcome to the team!</div>
              </div>
            </div>
          </div>
        </div>
