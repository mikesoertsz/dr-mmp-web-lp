...
export const Preheading = tw.h4`text-xs uppercase tracking-widest text-stone-600 font-poppins font-medium mb-2`;
export const Heading = tw.h2`text-2xl font-medium tracking-tight font-recoleta md:text-3xl lg:text-4xl text-stone-800`;
export const SubHeading = tw.h3`text-lg sm:text-xl font-light font-poppins tracking-tight subpixel-antialiased text-stone-600 max-w-lg`;
